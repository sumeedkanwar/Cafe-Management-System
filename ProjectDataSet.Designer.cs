...
namespace WindowsFormsApp1 {
    ...
    public partial class ProjectDataSet : global::System.Data.DataSet {
        ...
        public partial class ItemsDataTable : global::System.Data.TypedTableBase<ItemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ItemsRow AddItemsRow(int item_id, string item_name, decimal price) {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Items] WHERE (([item_id] = @Original_item_id) AND ([item_name]" +
                " = @Original_item_name) AND ([price] = @Original_price))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Items] ([item_id], [item_name], [price]) VALUES (@item_id, @it" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Items] SET [item_id] = @item_id, [item_name] = @item_name, [price] = @price WHERE (([item_id] = @Original_item_id) AND ([item_name] = @Original_item_name) AND ([price] = @Original_price));
SELECT item_id, item_name, price FROM Items WHERE (item_id = @item_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT item_id, item_name, price FROM dbo.Items";
        ...
        public virtual int Delete(int Original_item_id, string Original_item_name, decimal Original_price) {
        ...
        public virtual int Insert(int item_id, string item_name, decimal price) {
        ...
        public virtual int Update(int item_id, string item_name, decimal price, int Original_item_id, string Original_item_name, decimal Original_price) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string item_name, decimal price, int Original_item_id, string Original_item_name, decimal Original_price) {
            return this.Update(Original_item_id, item_name, price, Original_item_id, Original_item_name, Original_price);
        }
    }
